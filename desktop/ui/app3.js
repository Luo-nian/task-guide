...
const ICONS = {
  ...
  lv2: '<circle cx="12" cy="12" r="8.8"/><path d="M12 7.2 14.6 12l-2.6 4.8-2.6-4.8z"/>',
  lv3: '<path d="M2.5 7.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1M7.5 7.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1M12.5 7.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1"/><path d="M2.5 12.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1M7.5 12.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1M12.5 12.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1"/><path d="M2.5 17.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1M7.5 17.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1M12.5 17.5c.6.5 1.2 1 2.5 1s1.9-.5 2.5-1"/>',
  lv4: '<path d="M12 3.4 14.5 8.5 20 9.4 15.9 13.3 17 18.8 12 16.1 7 18.8 8.1 13.3 4 9.4 9.5 8.5z"/><circle cx="4.4" cy="4.4" r="1.2"/>',
  lv5: '<path d="M4 17.5V7l5.2 3.7L12 4.8l2.8 5.9L20 7v10.5z"/><path d="M4.5 20.8h15"/>',
  ...
  lv7: '<path d="M6 20.5V4"/><path d="M6 5.2c2.7 0 2.7-2 5.2-2 2.2 0 2.4 2 5.2 2 1.3 0 1.9-.4 1.9-.9V13c0 .5-.6.9-1.9.9-2.8 0-3-2-5.2-2s-2.4 2-5.2 2"/>',
  lv8: '<path d="M6.5 3.5h11L21 9.5 12 21 3 9.5z"/><path d="M3 9.5h18M9.9 9.5 12 21l2.1-11.5M6.5 3.5 9.9 9.5M17.5 3.5 14.1 9.5"/>',
